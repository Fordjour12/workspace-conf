...
--Important personal keymapping to me
vim.keymap.set('i', 'jk', '<ESC>', { desc = 'Exiting Insert Mode in Neovim' })
...
vim.keymap.set('t', 'ET', '<C-\\><C-n>', { desc = 'Exit terminal mode' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          end, '[G]oto [D]efinition with vertical split')
      ...
      local servers = {
        ...
        html = {
          ...
          settings = {
            html = {
              suggest = {
                -- Enable completion for all tags and attributes
                completion = {
                  callSnippet = 'Replace',
                },
              },
